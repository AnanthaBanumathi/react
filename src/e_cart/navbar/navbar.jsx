        ...
        <div className="nav_left">
           ...
           <div  >
            ...
            <ul className="nav_menu">
                    ...
                    <li onClick={()=>{SetMenu("mens")}}><Link style={{textDecoration:"none",color:'black'}} to={"/mens"}>Mens</Link>{menu==="mens"?<hr />:null}</li>
                    <li onClick={()=>{SetMenu("womens")}}><Link style={{textDecoration:"none",color:'black'}} to={"/womens"}>Womens</Link> {menu==="womens"?<hr />:null} </li>
